...
namespace GPIO
{
	public class DHT11Sensor: RemotlyAccessableDeviceBase, IInputMeter<float>
	{
		...
		public float Value { get { return m_type == DHT11ValueType.Temperature ? m_dht.Temperature : m_dht.Humidity; } }
